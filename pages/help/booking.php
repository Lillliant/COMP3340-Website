...
<head>
    <title>How to Manage Bookings</title>
    <!-- Common site-wide SEO metadata for Trekker Tours -->
    <?php include '../../assets/components/seo.php'; ?>
    <meta name="description" content="Admin guide for managing bookings on Trekker Tours. Learn how to view, edit, and delete tour reservations, and understand the bookings database schema.">
    <meta name="keywords" content="trekker tours, booking management, admin guide, edit bookings, delete bookings, tour reservations, database schema, travel admin">
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; gap: 1rem; text-align: justify;">
            ...
            <div>
                <ol style="text-align: justify;">
                    ...
                    <li>
                        Review all reservations, including customer details, trip dates, and booking status.
                    </li>
                </ol>
            </div>
            ...
            <ol style="text-align: justify;">
                ...
                <li>
                    Click "Book Now" to create the new booking record.
                </li>
            </ol>
            ...
            <ol style="text-align: justify;">
                ...
                <li>
                    Note that the final total price is dynamically calculated based on the selected options and group size. The price can be overriden if necessary, but change in previous selections will revert the override.
                </li>
            ...
            <embed src="/3340/assets/sql/booking.txt" type="text/plain" style="width: 100%; height: 500px; border: none; padding: 20px 0;">
        </div>
    </div>
</body>
