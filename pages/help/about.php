...
<body>
    ...
    <div class="my-2 mx-5 p-2">
        <h2 class="my-2">Who We Are</h2>
        <p style="text-align: justify;">
            Trekker Tour is an adventure travel company built for explorers, not tourists. We have a catalogue of unique, carefully curated tours that take you deep into the heart of each destination, away from the crowds and into the authentic experiences that make travel truly transformative. Each tour has at least two options, such as dining or tour experiences, to choose from. We specialize in small group tours designed for those who crave meaningful experiences—whether it’s hiking remote mountain trails, navigating jungle paths, or discovering hidden villages. Our trips are crafted to take you off the beaten path and deep into the heart of each destination.
            <br>
